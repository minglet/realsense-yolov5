...
def run():
    ...
    parser.add_argument("-i", "--input", default='./bag_files/detection.bag', type=str, help="Path to the bag file")
    ...
    while (True):
        ...
        img = cv2.resize(img, (640, 480))  # image resize (1280,720) -> (640,480)
        ...
        colorized_depth = cv2.resize(colorized_depth, (640, 480))  # depth_image resize (1280,720) -> (640,480)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    x_min = int(x_start + width * (1 / 2 - 1 / 3))
                    y_min = int(y_start + height * (1 / 2 - 1 / 3))
                    x_max = int(x_min + width * (2 / 3))
                    y_max = int(y_min + height * (2 / 3))
